...
$smarty->assign('nav',6);
$sql="SELECT  SQL_CALC_FOUND_ROWS * FROM `PRIZE` WHERE TYPE in ('joy-machine','joy-movie','joy-disk')  ORDER BY PR_ID DESC LIMIT ".$perpage*($page-1).",$perpage ";
...
$smarty->display("adm/prizeadmin2.html");
