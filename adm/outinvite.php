...
new initial('db');
$params['header']=array('ID','USERNAME','FB','EMAIL','IP','create time');

$sql="SELECT FVID ,NAME,CONCAT('https://www.facebook.com/',FB_ID) AS FB,EMAIL,IP,CREATE_TIME FROM `FB_INVITE` " ;
