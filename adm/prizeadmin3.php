...
$smarty->assign('nav',7);
$sql="SELECT  SQL_CALC_FOUND_ROWS * FROM `PRIZE` WHERE TYPE in ('share-machine','share-movie','share-disk')  ORDER BY PR_ID DESC LIMIT ".$perpage*($page-1).",$perpage ";
...
$smarty->display("adm/prizeadmin3.html");
